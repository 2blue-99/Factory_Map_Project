...
@AndroidEntryPoint
class CompareDialog: BaseDialog<DialogSpinnerBinding, SpinnerDialogViewModel>(
...
//        setRecyclerView(list, position, onSelect)
    ...
    companion object {
        ...
        fun newInstance(remoteList: List<String>, localList: List<String>): CompareDialog {
            return CompareDialog().apply {
